        ...
        <nav id="breadcrumb" class="flex p-4  w-full z-50 bg-white shadow">
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              <li class="inline-flex items-center">
                <a href="#" id="returnHome" class="inline-flex items-center text-sm font-medium text-gray-500 dark:text-gray-500 hover:text-blue-600  dark:hover:text-white breadcrumb-step active">
              ...
              <li>
                <div class="flex items-center">
                  ...
                  <a href="#" id="personal-info-step" class="ml-1 text-sm font-medium  hover:text-blue-600 md:ml-2 text-gray-500 dark:text-gray-500 dark:hover:text-white breadcrumb-step">Personal details</a>
                </div>
              </li>
