            ...
            <div id="avatarButton" class="flex items-center justify-between">
              <div class="flex items-start relative">
                ...
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="avatarButton">
                  ...
                  <li>
                    <a href="../html/list-view.html" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Department info</a>
                  </li>
                  <li>
                    <a href="../html/add-patient.html" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Add patient</a>
                  </li>
                </ul>
                <div class="py-1">
                  <a href="html/404_page.html" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Sign out</a>
                </div>
              </div>
                </div>
      ...
      <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full bg-gray-200 border-r border-gray-200 sm:translate-x-0" aria-label="Sidebar">
         <div class="h-full m-4 px-3 pb-4 overflow-y-auto bg-gray-200">
            <ul class="space-y-2 font-medium">
               ...
               <li>
                  <a href="html/add-patient.html" class="flex items-center p-2 text-gray-900 rounded-lg">
               ...
               <li>
                  <a href="../html/404_page.html" class="flex items-center p-2 text-gray-900 rounded-lg">
               ...
               <li>
               <a href="../html/list-view.html" class="flex items-center p-2 text-gray-900 rounded-lg">
               ...
               <li>
                  <a href="html/404_page.html" class="flex items-center p-2 text-black rounded-lg">
