class releasePatientForm extends HTMLElement {
    ...
    connectedCallback() {
        ...
        <form id="delete_patient" class="p-4 mx-auto relative z-10" action="#" method="post">
          ...
          <div id="modal" class="fixed top-0 left-0 right-0 bottom-0 hidden bg-black bg-opacity-50 z-50 ">
          <div style="background-color: #fff; padding: 2rem; border-radius: 0.5rem; width: 400px; max-width: 90%; margin: 20px auto;">
            ...
            <div class="flex justify-end mt-4">
              ...
              <button type="submit" form="delete_patient" id="modal-delete-button" class="rounded-md bg-red-500 px-4 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-400">Delete</button>
            </div>
          </div>
        </div>
        </form>
