...
<html lang="en">
  ...
  <body>
    ...
    <main>
      <section id="container" class="p-4 sm:ml-64 m-16">
        <div class="container mx-auto">
         <div class="grid grid-cols-1 md:grid-cols-2 gap-4 h-screen">
          <div class="bg-gray-200 p-4" >
          <h1 class="text-center" id="rubik" style="font-size: 20px;">Doctor's On Call</h1>
          ...
          <div class="bg-gray-200 p-4">
          <h1 class="text-center" id="rubik" style="font-size: 20px;">Department Load In Real Time</h1>
              ...
              <div class="m-4">
                <img src="assets/svg/file1.svg" class="w-24 h-20 md:w-32 md:h-28" alt="Department Icon">
                          <h2 class="text-center text-lg md:text-xl">2824</h2>
                                ...
                                <h3 class="text-center text-sm md:text-base mt-2 md:mt-4 text-red-600" id="kanit">176 Available Beds</h3>
                              </div>
                            </div>
                          </div>
                        </div>
                    <div class="bg-gray-200 p-4">
                        <h1 class="text-center" id="rubik" style="font-size: 20px;">System Recommendations</h1>
                        <div id="logsContainer" class="container mx-auto p-4 h-80 overflow-y-auto">
                        </div>
                        </div>
                        <div class="bg-gray-200 p-4">
                            <h1 class="text-center" id="rubik" style="font-size: 20px;">General Bed Occupancy</h1>
